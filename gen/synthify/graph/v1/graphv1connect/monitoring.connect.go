...
const (
	...
	MonitoringServiceName = "synthify.graph.v1.MonitoringService"
)
...
const (
	...
	MonitoringServiceGetPipelineStatsProcedure = "/synthify.graph.v1.MonitoringService/GetPipelineStats"
	...
	MonitoringServiceGetExtractionStatsProcedure = "/synthify.graph.v1.MonitoringService/GetExtractionStats"
	...
	MonitoringServiceGetEvaluationTrendProcedure = "/synthify.graph.v1.MonitoringService/GetEvaluationTrend"
	...
	MonitoringServiceListFailedDocumentsProcedure = "/synthify.graph.v1.MonitoringService/ListFailedDocuments"
	...
	MonitoringServiceGetNormalizationStatsProcedure = "/synthify.graph.v1.MonitoringService/GetNormalizationStats"
	// MonitoringServiceGetAliasStatsProcedure is the fully-qualified name of the MonitoringService's
	// GetAliasStats RPC.
	MonitoringServiceGetAliasStatsProcedure = "/synthify.graph.v1.MonitoringService/GetAliasStats"
)
...
func NewMonitoringServiceHandler(svc MonitoringServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/synthify.graph.v1.MonitoringService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
