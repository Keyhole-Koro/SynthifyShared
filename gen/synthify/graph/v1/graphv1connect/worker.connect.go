...
const (
	...
	WorkerServiceGenerateExecutionPlanProcedure = "/synthify.graph.v1.WorkerService/GenerateExecutionPlan"
	...
	WorkerServiceEvaluateJobArtifactProcedure = "/synthify.graph.v1.WorkerService/EvaluateJobArtifact"
)
...
// GenerateExecutionPlan calls synthify.graph.v1.WorkerService.GenerateExecutionPlan.
...
// ExecuteApprovedPlan calls synthify.graph.v1.WorkerService.ExecuteApprovedPlan.
...
// EvaluateJobArtifact calls synthify.graph.v1.WorkerService.EvaluateJobArtifact.
...
func (UnimplementedWorkerServiceHandler) GenerateExecutionPlan(context.Context, *connect.Request[v1.GenerateExecutionPlanRequest]) (*connect.Response[v1.GenerateExecutionPlanResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.graph.v1.WorkerService.GenerateExecutionPlan is not implemented"))
}
...
func (UnimplementedWorkerServiceHandler) EvaluateJobArtifact(context.Context, *connect.Request[v1.EvaluateJobArtifactRequest]) (*connect.Response[v1.EvaluateJobArtifactResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.graph.v1.WorkerService.EvaluateJobArtifact is not implemented"))
}
