...
const (
	...
	DocumentServiceResumeProcessingProcedure = "/synthify.graph.v1.DocumentService/ResumeProcessing"
)
...
// ResumeProcessing calls synthify.graph.v1.DocumentService.ResumeProcessing.
...
func (UnimplementedDocumentServiceHandler) ResumeProcessing(context.Context, *connect.Request[v1.ResumeProcessingRequest]) (*connect.Response[v1.ResumeProcessingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.graph.v1.DocumentService.ResumeProcessing is not implemented"))
}
