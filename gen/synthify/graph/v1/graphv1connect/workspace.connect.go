...
const (
	...
	WorkspaceServiceName = "synthify.graph.v1.WorkspaceService"
)
...
const (
	...
	// CreateWorkspace RPC.
	WorkspaceServiceCreateWorkspaceProcedure = "/synthify.graph.v1.WorkspaceService/CreateWorkspace"
	...
	// InviteMember RPC.
	WorkspaceServiceInviteMemberProcedure = "/synthify.graph.v1.WorkspaceService/InviteMember"
	// WorkspaceServiceUpdateMemberRoleProcedure is the fully-qualified name of the WorkspaceService's
	// UpdateMemberRole RPC.
	WorkspaceServiceUpdateMemberRoleProcedure = "/synthify.graph.v1.WorkspaceService/UpdateMemberRole"
	// WorkspaceServiceRemoveMemberProcedure is the fully-qualified name of the WorkspaceService's
	// RemoveMember RPC.
	WorkspaceServiceRemoveMemberProcedure = "/synthify.graph.v1.WorkspaceService/RemoveMember"
	// WorkspaceServiceTransferOwnershipProcedure is the fully-qualified name of the WorkspaceService's
	// TransferOwnership RPC.
	WorkspaceServiceTransferOwnershipProcedure = "/synthify.graph.v1.WorkspaceService/TransferOwnership"
)

// WorkspaceServiceClient is a client for the synthify.graph.v1.WorkspaceService service.
...
// NewWorkspaceServiceClient constructs a client for the synthify.graph.v1.WorkspaceService service.
...
func NewWorkspaceServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) WorkspaceServiceClient {
	...
	workspaceServiceMethods := v1.File_synthify_graph_v1_workspace_proto.Services().ByName("WorkspaceService").Methods()
...
// CreateWorkspace calls synthify.graph.v1.WorkspaceService.CreateWorkspace.
...
// InviteMember calls synthify.graph.v1.WorkspaceService.InviteMember.
...
// UpdateMemberRole calls synthify.graph.v1.WorkspaceService.UpdateMemberRole.
...
// RemoveMember calls synthify.graph.v1.WorkspaceService.RemoveMember.
...
// TransferOwnership calls synthify.graph.v1.WorkspaceService.TransferOwnership.
...
// WorkspaceServiceHandler is an implementation of the synthify.graph.v1.WorkspaceService service.
...
func NewWorkspaceServiceHandler(svc WorkspaceServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/synthify.graph.v1.WorkspaceService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedWorkspaceServiceHandler) CreateWorkspace(context.Context, *connect.Request[v1.CreateWorkspaceRequest]) (*connect.Response[v1.CreateWorkspaceResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.graph.v1.WorkspaceService.CreateWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) ListWorkspaces(context.Context, *connect.Request[v1.ListWorkspacesRequest]) (*connect.Response[v1.ListWorkspacesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.graph.v1.WorkspaceService.ListWorkspaces is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) InviteMember(context.Context, *connect.Request[v1.InviteMemberRequest]) (*connect.Response[v1.InviteMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.graph.v1.WorkspaceService.InviteMember is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) UpdateMemberRole(context.Context, *connect.Request[v1.UpdateMemberRoleRequest]) (*connect.Response[v1.UpdateMemberRoleResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.graph.v1.WorkspaceService.UpdateMemberRole is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) RemoveMember(context.Context, *connect.Request[v1.RemoveMemberRequest]) (*connect.Response[v1.RemoveMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.graph.v1.WorkspaceService.RemoveMember is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) TransferOwnership(context.Context, *connect.Request[v1.TransferOwnershipRequest]) (*connect.Response[v1.TransferOwnershipResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.graph.v1.WorkspaceService.TransferOwnership is not implemented"))
}
