...
const (
	...
	UserServiceName = "synthify.tree.v1.UserService"
)
...
const (
	...
	UserServiceSyncUserProcedure = "/synthify.tree.v1.UserService/SyncUser"
	// UserServiceGetMeProcedure is the fully-qualified name of the UserService's GetMe RPC.
	UserServiceGetMeProcedure = "/synthify.tree.v1.UserService/GetMe"
)

// UserServiceClient is a client for the synthify.tree.v1.UserService service.
...
// NewUserServiceClient constructs a client for the synthify.tree.v1.UserService service. By
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	userServiceMethods := v1.File_synthify_tree_v1_user_proto.Services().ByName("UserService").Methods()
...
// SyncUser calls synthify.tree.v1.UserService.SyncUser.
...
// GetMe calls synthify.tree.v1.UserService.GetMe.
...
// UserServiceHandler is an implementation of the synthify.tree.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/synthify.tree.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) SyncUser(context.Context, *connect.Request[v1.SyncUserRequest]) (*connect.Response[v1.SyncUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.tree.v1.UserService.SyncUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetMe(context.Context, *connect.Request[v1.GetMeRequest]) (*connect.Response[v1.GetMeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.tree.v1.UserService.GetMe is not implemented"))
}
