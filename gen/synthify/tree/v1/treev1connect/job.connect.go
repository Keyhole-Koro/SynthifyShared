...
const (
	...
	JobServiceName = "synthify.tree.v1.JobService"
)
...
func NewJobServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) JobServiceClient {
	...
	jobServiceMethods := v1.File_synthify_tree_v1_job_proto.Services().ByName("JobService").Methods()
...
// GetJobExecutionPlan calls synthify.tree.v1.JobService.GetJobExecutionPlan.
...
// ListJobApprovalRequests calls synthify.tree.v1.JobService.ListJobApprovalRequests.
...
// RequestJobApproval calls synthify.tree.v1.JobService.RequestJobApproval.
...
// ApproveJobApproval calls synthify.tree.v1.JobService.ApproveJobApproval.
...
// RejectJobApproval calls synthify.tree.v1.JobService.RejectJobApproval.
...
func (UnimplementedJobServiceHandler) GetJobStatus(context.Context, *connect.Request[v1.GetJobStatusRequest]) (*connect.Response[v1.GetJobStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.tree.v1.JobService.GetJobStatus is not implemented"))
}
...
func (UnimplementedJobServiceHandler) GetJobExecutionPlan(context.Context, *connect.Request[v1.GetJobExecutionPlanRequest]) (*connect.Response[v1.GetJobExecutionPlanResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.tree.v1.JobService.GetJobExecutionPlan is not implemented"))
}
...
func (UnimplementedJobServiceHandler) ListJobApprovalRequests(context.Context, *connect.Request[v1.ListJobApprovalRequestsRequest]) (*connect.Response[v1.ListJobApprovalRequestsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.tree.v1.JobService.ListJobApprovalRequests is not implemented"))
}
...
func (UnimplementedJobServiceHandler) RequestJobApproval(context.Context, *connect.Request[v1.RequestJobApprovalRequest]) (*connect.Response[v1.RequestJobApprovalResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.tree.v1.JobService.RequestJobApproval is not implemented"))
}
...
func (UnimplementedJobServiceHandler) ApproveJobApproval(context.Context, *connect.Request[v1.ApproveJobApprovalRequest]) (*connect.Response[v1.ApproveJobApprovalResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("synthify.tree.v1.JobService.ApproveJobApproval is not implemented"))
}
